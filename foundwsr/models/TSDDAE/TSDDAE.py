...
@register_model("TSDDAE")
class TSDDAE(BaseModel):
    @classmethod
    ...
    def __init__(self, input_dim, hidden_dim, num_heads, num_layers, ff_hidden_dim):
        super().__init__()
        ...
        for _ in range(num_layers):
            self.time_encoder.append(TimeLayer(hidden_dim, time_dim, num_heads, ff_hidden_dim))
